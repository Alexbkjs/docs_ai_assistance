...
seoDescription: Before you start using the Lably application, we recommend you get acquainted with frequently asked questions.
...
*   [Can I display labels to customers based on their location?](#1-can-i-display-labels-to-customers-based-on-their-location)
*   [Can I display labels and badges for specific products?](#1-can-i-display-labels-and-badges-for-specific-products)
*   [How to schedule labels and badges display?](#1-how-to-schedule-labels-and-badges-display)
