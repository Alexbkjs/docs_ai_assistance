---
type: page
title: Sending emails on React Flow plans
seoTitle: Sending emails on React Flow plans
seoDescription: About limits
slug: sending-emails-on-react-flow-plans
order: 12
status: published
---
...
# Sending emails on React Flow plans

# Plans Limitations

In this article:

*   [About limits](#1-about-limits)
*   [How to increase the limit?](#1-how-to-increase-the-limit)
...
Note: sending emails through your [connector](/react-flow-connectors) remains unlimited.
