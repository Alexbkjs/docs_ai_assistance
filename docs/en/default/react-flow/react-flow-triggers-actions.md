...
*   [React Flow Triggers and Actions](#1-react-flow-triggers-and-actions)
*   [How it works?](#1-how-it-works)
*   [Order triggers](#1-order-triggers)
*   [Customer triggers](#1-customer-triggers)
*   [Product triggers](#1-product-triggers)
*   [Actions](#1-actions)
*   [If you can't find the trigger or action you want?](#1-if-you-cant-find-the-trigger-or-action-you-want)
