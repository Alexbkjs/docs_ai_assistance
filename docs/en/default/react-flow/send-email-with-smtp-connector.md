...
# What is SMTP and SMTP connector?
...
# How to activate SMTP connector?
...
3.  Enter your user name, password and email. We have prepared [an article](/react-flow/google-email-hosting-provider) in which you can find information on where to get this data.
...
1.  Such a workflow is already in the [Templates](/react-flow/react-flow-templates) and you can quickly set it up. Click on **Templates**.
