...
title: Functions
seoTitle: Functions
seoDescription: What are Functions?
slug: functions
order: 6
status: published
---
...
*   [What are Functions?](#1-what-are-functions)
*   [Available Functions](#1-available-functions)
...
![](https://cdn.heymantle.com/docs/screenshots/aa128a37-7f15-4952-9503-369ef4b8eefc/functions-option_6lh1mr.png)

Note: If you want to learn more about Shopify Features, please refer to this article – [<u><span style="white-space:pre-wrap" class="csh-markdown csh-markdown-underline">About Shopify Functions</span></u>](https://shopify.dev/docs/apps/build/functions).
