...
*   [What is the reason for partially paid orders?](#1-what-is-the-reason-for-partially-paid-orders)
*   [How does it happen?](#1-how-does-it-happen)
*   [What does a customer see for Partially paid orders?](#1-what-does-a-customer-see-for-partially-paid-orders)
*   [How to identify partially paid orders?](#1-how-to-identify-partially-paid-orders)
*   [Resolving partially paid orders](#1-resolving-partially-paid-orders)
...
# ✔️ What does a customer see for Partially paid orders?
...
# ✔️ How to identify partially paid orders?
...
# ✔️ Resolving partially paid orders
...
Learn more about how to [customize your offers](/can-i-customize-my-offers) and check the examples of popular offers to [get maximum benefits using Resell](/get-maximum-benefits-using-resell).
